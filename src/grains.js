        ...
        <div>
            ...
            <div className="container223">
                ...
                <NavLink to={'/vegetables'}>
                    <button className="buttonz">
                        <p style={{ marginTop: "32px", marginLeft: "75px", fontWeight: '600', alignSelf: "center" }}>Fruits</p>
                    </button>
                </NavLink>

                <NavLink to={'/vegetables'}>
                    <button className="buttonz">
                        <p style={{ marginTop: "35px", marginLeft: "75px", fontWeight: '600', alignSelf: "center", marginTop: '32px', fontSize: '14px' }}>Vegtables</p>
                    </button>
                </NavLink>

                <NavLink to={'/grains'}>
                    <button className="buttonz">
                        <p style={{ marginTop: "15px", marginLeft: "76px", fontWeight: '600', lineHeight: "50px", color: '#2F945C', fontSize: '16px' }}>Grains</p>
                    </button>
                </NavLink>
            ...
            <div style={{ display: 'flex', }}>
                ...
                <div className="container4">
                    <div className="pp">
                        <p style={{ fontSize: '40px', fontWeight: '500', color: '#101928', marginLeft: '30px', color: '#2F945C' }}>Grains</p>
                        <p style={{ marginLeft: '678px', marginTop: '70px', fontSize: '14px', fontWeight: '400', color: 'black' }}>
