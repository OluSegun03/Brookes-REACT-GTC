    ...
    return (
        <div>
            ...
            <NavLink to={'/landing'}>
                ...
                <NavLink to={'/fruits'}>
                    <button className="buttonz">
                        <p style={{ marginTop: "32px", marginLeft: "75px", alignSelf: "center", fontWeight: '600', fontSize: '16px', color: '#2F945C' }}>Fruits</p>
                    </button>
                </NavLink>
            ...
            <div style={{ display: 'flex', }}>
                <div className="container3">
                    <p style={{ color: '#2F945C', fontSize: '14px', fontWeight: '500', marginBottom: '30px' }}>Home / Fruits</p>
                ...
                <div className="container4">
                    <div className="pp">
                        <p style={{ fontSize: '40px', fontWeight: '500', color: '#101928', marginLeft: '30px', color: '#2F945C' }}>Fruits</p>
